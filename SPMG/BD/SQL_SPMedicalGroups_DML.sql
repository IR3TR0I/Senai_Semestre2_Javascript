...
INSERT INTO Clinicas(cnpj, nomeFantasia, razaoSocial, endereço,HorarioFuncionamento,HorarioFechamento)
VALUES	('86400902000130', 'Clínica Possarle', 'SP Medical Group', 'Av. Barão Limeira, 532, São Paulo, SP', '7:00', '23:00');
GO

INSERT INTO Prontuarios(IdUsuario,NomeProntuario,CPF,RG,DataNascimento,TelefoneProntuario,Endereço)
...
INSERT INTO Situações(tituloSituação)
VALUES ('REALIZADA'),
		('Cancelada'),
		('Agendada');
GO

INSERT INTO consultas(idMedico, idProntuario, IdSituação, dataConsulta, DataConsulta, Relatorio)
...
INSERT INTO consultas(idMedico, idProntuario, IdSituação, dataConsulta, DataConsulta)
